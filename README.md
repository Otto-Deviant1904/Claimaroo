...
| `LOCAL_VISION_URL` | Self-hosted YOLOv8 damage classifier. `POST { filename, mime_type, image_base64 }`, 8s timeout. Laptop: `http://127.0.0.1:8901/analyse` (cloudflared for Vercel). Colab: serve cell in [`notebooks/colab_nb.ipynb`](notebooks/colab_nb.ipynb). Ops: `~/Downloads/claimaroo-test/README.md` | — |
